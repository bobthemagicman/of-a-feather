 ...
 *
 */
public class AsyncOutOfRegionResponse extends BaseAsyncResponse
{
    private final SearchResultsUIModel searchResultUIModel;
    
    public AsyncOutOfRegionResponse(SearchResultsUIModel searchResultUIModel, String successMessage)
    {
    ...
    public AsyncOutOfRegionResponse()
    {
    ...
    public AsyncOutOfRegionResponse(AsyncError error, String errorMessage)
    {
