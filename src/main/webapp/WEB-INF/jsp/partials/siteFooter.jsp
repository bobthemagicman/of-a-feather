...
<spring:url value="/termsConditions" var="termsConditions" />
    <div class="footer">
        ...
        <div class="footer-content">
            <div class="links"><a href="https://docs.google.com/forms/d/1z7UPHqIvfdLTmiy_U9HFsd9Pud6mXWjd-uWrUQwwFZo/viewform" target="_blank">LOCAL EVENTS</a> | <a href="${aboutUsLink}">ABOUT US</a> | <a href="${addYourChurchLink}">ADD YOUR CHURCH</a> | <a href="${contactUsLink}">CONTACT</a> | <a href="${termsConditions}">TERMS AND CONDITIONS</a> | <a href="${privacyPolicy}">PRIVACY POLICY</a></div>
