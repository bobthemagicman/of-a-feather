...
(function( $ ){
  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      $year.wrap('<div class="col-sm-4" style="padding-right:0;"></div>');
      $month.wrap('<div class="col-sm-4" style="padding-left:0;"></div>');
      $day.wrap('<div class="col-sm-4"></div>');
...
$(document).ready(function() {
   $("#birthdateSelection").birthdaypicker({}); 
});